...
class BlueArchiveMacro:
    ...
    def create_ui(self):
        ...
        self.action_type = ttk.Combobox(config_frame, width=8, values=["点位", "拖动"], font=("", font_size))
        ...
        ttk.Label(config_frame, text="循环间隔 (秒):").grid(row=2, column=4, padx=padx, pady=pady, sticky=tk.W)
        ...
        self.loop_interval.insert(0, "0.02")
