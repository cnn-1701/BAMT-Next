...
class BlueArchiveMacro:
    ...
    def create_ui(self):
        try:
            ...
            button_width = 15  # 统一按钮宽度（字符数）
            list_height = 15   # 列表高度（行数）
            font_size = self.dpi.scale(12)  # 增大字体大小
            ...
            self.res_combo = ttk.Combobox(res_frame, width=18, values=[
            ...
            self.action_name = ttk.Entry(config_frame, width=18)
            ...
            self.hotkey_entry = ttk.Entry(config_frame, width=5)
            ...
            self.action_type = ttk.Combobox(config_frame, width=8, values=["点位", "拖动"])
            ...
            self.target_x = ttk.Entry(config_frame, width=6)
            self.target_x.grid(row=1, column=3, padx=padx, pady=pady)
            
            self.target_y = ttk.Entry(config_frame, width=6)
            ...
            self.up_drag_distance = ttk.Entry(config_frame, width=6)
            ...
            self.drag_duration = ttk.Entry(config_frame, width=6)
            ...
            self.loop_interval = ttk.Entry(config_frame, width=6)
